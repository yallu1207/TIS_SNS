...
<script>
	...
	<h1 align="center">소모임 등록</h1>
		<form class="form-horizontal" role="form" id="mf" action="write" method="post" enctype="multipart/form-data">
		<input type="hidden" name="mode" value="write">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-3">
                  <input type="date" class="form-control" id="mdate" name="mdateStr">
                </div>
                <div class="col-sm-3">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-2">
                  <input type="text" class="form-control" id="hp1" name="hp1" maxlength="3" placeholder="000">
                </div>
                <div class="col-sm-2">
                  <input type="text" class="form-control" id="hp2" name="hp2" maxlength="4" placeholder="0000">
                </div>
                <div class="col-sm-2">
                  <input type="text" class="form-control" id="hp3" name="hp3" maxlength="4" placeholder="0000">
                </div>
              </div>
              <div class="form-group">
                <div class="col-sm-3">
